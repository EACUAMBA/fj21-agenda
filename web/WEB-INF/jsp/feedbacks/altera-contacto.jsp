...
<div class="container">
    <div>
        <h1>Altere o seu contacto!</h1>
    </div>
    <form action="/mvc?logica=AlteraContactoLogicSave&id=${contacto.id}" method="POST">
        <fieldset>
            <h2>Preencha o formulario abaixo:</h2>
            <div class="label-input">

                <label for="nome">ID: </label>
                <input type="number" id="nome" name="nome" value="${contacto.id}" disabled>

                <label for="nome">Nome: </label>
                <input type="text" id="nome" name="nome" value="${contacto.nome}">

                <label for="email">Email: </label>
                <input type="email" id="email" name="email" value="${contacto.email}">

                <label for="endereco">Endereço: </label>
                <input type="text" id="endereco" name="endereco" autocomplete="false" value="${contacto.endereco}">

                <label for="dataNascimento">Data de nascimento: </label>
                <data:campoData id="dataNascimento"  value="${contacto.dataNascimento}"/>
            </div>
            <div class="button">
